# Operator Quickstart — Trusts, funds and similar financial entities

Shortest path from clone to a verified local dry-run for **ISIC 6430** (`cloud-itonami-isic-6430`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-6430.git
cd cloud-itonami-isic-6430
```
...
- Blueprint governor key: `trust-fund-governor`
- Likely source path: `trustfund.governor.cljc`
